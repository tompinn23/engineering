...
public abstract class IMultiblockPart extends TileEntity {
	...
	/**
	 * Returns the location of this tile entity in the world, in BlockPos form.
	 * @return A BlockPos with its x,y,z members set to the location of this tile entity in the world.
	 */
